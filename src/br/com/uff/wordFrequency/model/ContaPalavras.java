...
public class ContaPalavras {
	...
	//(1.2) abre o arquivo
        FileReader txtFile = new FileReader("C:\\Users\\kaio.teixeira\\git\\wordFrequency\\src\\arquivo\\Comentarios.txt");
	...
	//-------------------------------------------------------
	 ...
	 properties.store(new FileOutputStream("C:\\Users\\kaio.teixeira\\git\\wordFrequency\\src\\arquivo\\Frequencia.txt"), null);
*/
        return mapPalavras;
   }
